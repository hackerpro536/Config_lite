...
require 'Lite/Exception.php';
require 'Lite/Exception/InvalidArgument.php';
require 'Lite/Exception/Runtime.php';
require 'Lite/Exception/UnexpectedValue.php';
 ...
 * @link      https://github.com/pce/config_lite
 */
class ConfigLite implements ArrayAccess, IteratorAggregate, Countable, Serializable
{
    /**
    ...
    public function getString($sec, $key, $default = null)
    {
        ...
        if (isset($this->sections[$sec]) && array_key_exists($key, $this->sections[$sec])) {
    ...
    public function get($sec = null, $key = null, $default = null)
    {
        ...
        throw new Config_Lite_Exception_UnexpectedValue(
            'key not found, no default value given.' . $sec . $key . $default
        );
    }
